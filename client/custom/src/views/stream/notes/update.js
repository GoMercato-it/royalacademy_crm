define('custom:views/stream/notes/update', ['views/stream/notes/update'], function (BaseView) {
...
{{#if workflowDefinitionName}}
    <div class="stream-post-container">
        <span class="text-muted small">{{workflowLabel}}: {{workflowDefinitionName}}</span>
    </div>
{{/if}}
...
`;
        ...
        setup() {
            ...
            this.workflowDefinitionId = data.workflowDefinitionId || null;
            this.workflowDefinitionName = data.workflowDefinitionName || null;
            this.workflowLabel = this.translate('workflowLabel', 'messages');
        }
